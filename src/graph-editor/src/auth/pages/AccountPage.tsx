...
const AccountPage: FC = React.memo(() => {
    ...
    const freeGraphs = graphs.currentData?.filter((g: { graphType: string; }) => g.graphType == "Free") as Graph[];
    const instanceGraphs = graphs.currentData?.filter((g: { graphType: string; }) => g.graphType == "InstanceGraph") as Graph[];
    const classGraphs = graphs.currentData?.filter((g: { graphType: string; }) => g.graphType == "ClassGraph") as Graph[];
